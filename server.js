...
const WTT_EVENT_PUBLIC_URLS = {
  ...
  "3473": "https://results.asiangames2026.org/#/discipline/TTE/reports",
...
function buildBaseProcessedMatchesOptions(options = {}) {
  return {
    ...
    ittfArchiveDir: options.ittfArchiveDir || ITTF_ARCHIVE_DIR,
    ittfSlimArchiveDir: options.ittfSlimArchiveDir || ITTF_SLIM_ARCHIVE_DIR,
    ...
    bundledIttfArchiveDir: options.bundledIttfArchiveDir || path.join(__dirname, "ittf-records"),
    bundledIttfSlimArchiveDir: options.bundledIttfSlimArchiveDir || path.join(__dirname, "ittf-records-slim"),
...
const HEAD_TO_HEAD_STARTUP_RECONCILE_ENABLED = process.env.HEAD_TO_HEAD_STARTUP_RECONCILE_ENABLED === "1"
  || (process.env.HEAD_TO_HEAD_STARTUP_RECONCILE_ENABLED !== "0" && Boolean(process.env.RENDER_GIT_COMMIT));
